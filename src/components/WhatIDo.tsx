        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                ...
                analysis and visualization to drive data-informed decision making.
              </p>
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">Visualisation</div>
              </div>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Designing and deploying intelligent systems, from predictive 
                modeling to advanced NLP solutions and automated AI pipelines.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                <div className="what-tags">Python</div>
